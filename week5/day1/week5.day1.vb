3:00 to 4:00 --->Frames
4:00 to 4:45 --->WindowHandle
4:45 to 5:15 --->BreakOut+Break
5:15 to 6:00 --->WebTable
...
Webtable Types:
1.static-->no of rows and columns remains same
2.dynamic-->size of rows and columns changed
structure of webtable:
    <table>
     <thead>--->tableheader
      <tr>--->tableRow
       <th>-->column info of header row
       </th>
      </tr>
